...
Playback::Playback(float xWidth, float yWidth, float zWidth, int numPs, int argc, char** argv)
{
...
void Playback::timer(int id)
{
	glutPostRedisplay();
}

void Playback::display(void)
{
